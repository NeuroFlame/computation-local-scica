...
# Component IDs
SCICA_AGGREGATOR_ID = "scica_aggregator"

class ScicaController(Controller):
    """
...
### This is where computation authors will define the control flow logic ###
    ...
    def start_controller(self, fl_ctx: FLContext) -> None:
        ...
        self.srr_aggregator = self._engine.get_component(SCICA_AGGREGATOR_ID)
    ...
    def control_flow(self, abort_signal: Signal, fl_ctx: FLContext) -> None:
        ...
        :param fl_ctx: Federated learning context for this run.
        """
        # Broadcast the local scica task and send site results to the aggregator
